...
module.exports = function() {
 ...
 //    	})
	...
	// 					self.sendMail(atkList[i]["uid"],"攻城战参与奖励","您参与本次公会活动【攻城战】，挑战【"+guild_city[cityId]["name"]+"】时获得了参与奖励",guild_city[cityId]["play"])
	...
	// 					rank++
	// 					self.sendMail(list[i],"攻城战排名奖励","您参与本次公会活动【攻城战】，挑战【"+guild_city[cityId]["name"]+"】时获得了获得了伤害第"+rank+"名，获得了排名奖励",guild_city[cityId]["damage_"+rank])
	// 				}
	// 			})
	// 			next()
	// 		},

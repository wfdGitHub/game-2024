...
const areaServers = ["recharge","activity","weekTarget","tour","zhulu","bazzar","combatEffectiveness","arena","bag","dao","checkpoints","mail","ttttower","lord","daily_fb","task","limit_gift","area_challenge","area_boss","sprint_rank","share","rebate","stone","festival","guild","guild_fb","guild_treasure","limited_time","hufu","show","friend","beherrscher","exercise","endless","extremity","zhanfa","hero_rank","gather","hero","guild_city_boss","manor","lotto","worldLevel","area_gift","equip","worldBoss","invade","gem","fabao","cangbaotu","aceLotto","medal"]
...
area.prototype.dayFirstLogin = function(uid) {
	...
	this.setPlayerData(uid,"diaopiao_use",0)

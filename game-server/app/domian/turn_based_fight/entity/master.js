...
var master = function(otps) {
	...
	this.phyAtk = 0 									//物攻加成
	this.magAtk = 0 								    //法攻加成
	this.neglect_def = 0 					 			//忽视防御比例
	this.neglect_phy = 0 					 			//忽视物防比例
	this.neglect_mag = 0 					 			//忽视法防防比例
	this.attInfo = {}
	this.attInfo.maxHP = 0								//最大生命值
	this.attInfo.atk = 0								//攻击力
	this.attInfo.phyDef = 0								//物理防御力
	this.attInfo.magDef = 0								//法术防御力
	this.attInfo.phyAtk = Math.ceil(otps["phyAtk"] || 0)//物攻加成
	this.attInfo.magAtk = Math.ceil(otps["magAtk"] || 0)//法攻加成
